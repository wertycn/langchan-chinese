...
查看[S3DirectoryLoader的使用示例](/docs/modules/data_connection/document_loaders/integrations/aws_s3_directory.html)。

查看[S3FileLoader的使用示例](/docs/modules/data_connection/document_loaders/integrations/aws_s3_file.html)。
